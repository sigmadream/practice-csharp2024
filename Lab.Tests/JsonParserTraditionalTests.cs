namespace DS.Lab.Tests
{
    ...
    public class JsonParserTraditionalTests
    {
        ...
        public void Parse_ValidJsonObject_ReturnsCorrectDictionary()
        {
            ...
            var result = (Dictionary<string, object>)JsonParserTraditional.Parse(json);
        ...
        public void Parse_ValidJsonArray_ReturnsCorrectList()
        {
            ...
            var result = (List<object>)JsonParserTraditional.Parse(json);
        ...
        public void Parse_InvalidJson_ThrowsException()
        {
            ...
            var ex = Assert.Throws<Exception>(() => JsonParserTraditional.Parse(json));
